  ...
  $.fn.qrcode = function(h) {
    ...
    o.prototype = {
      ...
      getBestMaskPattern: function() {
        for (var a = 0, c = 0, d = 0; 8 > d; d++) {
          this.makeImpl(!0, d);var b = j.getLostPoint(this);
          if (0 == d || a > b) a = b, c = d
        }
        return c
      },
          ...
          for (6 == i && i--;;) {
            for (var g = 0; 2 > g; g++)
              if (null == this.modules[b][i - g]) {
                var n = !1;
                f < a.length && (n = 1 == (a[f] >>> e & 1));j.getMask(c, b, i - g) && (n = !n);
    ...
    o.createData = function(a, c, d) {
      for (var c = p.getRSBlocks(a,
        ...
        var f = d[e];
        b.put(f.mode, 4);b.put(f.getLength(), j.getLengthInBits(f.mode, a));f.write(b)
      }
    ...
    h = $.extend({}, {
      ...
      var a;
      if ("canvas" == h.render) {
        a = new o(h.typeNumber, h.correctLevel);a.addData(h.text);a.make();
